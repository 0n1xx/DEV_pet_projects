<?php
    class Database{
        ...
        /* Overall, I'm going to write everything that is related to database here
         * By that I mean: a connection to the database, validation, create and read method
         * By doing it this way, I have everything which is related to database in one class
         * This means that every time I have an error connected to a database, I know where to start looking
         */
        ...
        public function __construct(){
            try{
                ...
                // Writing a log of potential error, for instance if we built a server using a Docker
                // We would be able to create a config where all config logs are stored
                // Here I just did it to know new properties of error handling and manipulation
        ...
        public function validateImage(array $fileData){
            ...
            if ($imageInfo[0] > $maxWidth || $imageInfo[1] > $maxHeight) {
                $this->error = "Image dimensions exceed allowed limit (2000x2000).";
                return false;
            }
